...
public class StatusAppUtils {
    public static final int DEFAULT_STATUS_BAR_ALPHA = 0;
    private static final int FAKE_TRANSLUCENT_VIEW_ID = R.id.fake_status_bar_view;
    ...
    @TargetApi(Build.VERSION_CODES.M)
    public static void setLightModes(Activity activity) {
        setMIUIStatusBarDarkIcon(activity, true);
        setMeizuStatusBarDarkIcon(activity, true);
    }
    ...
    @TargetApi(Build.VERSION_CODES.M)
    public static void setDarkModes(Activity activity) {
        setMIUIStatusBarDarkIcon(activity, false);
        setMeizuStatusBarDarkIcon(activity, false);
     ...
     * @param statusBarAlpha 透明值
     */
    private static void addTranslucentView(Activity activity, @IntRange(from = 0, to = 255) int statusBarAlpha, int color) {
        ViewGroup contentView = (ViewGroup) activity.findViewById(android.R.id.content);
        View fakeTranslucentView = contentView.findViewById(FAKE_TRANSLUCENT_VIEW_ID);
     ...
     * @return 状态栏高度
     */
    public static int getStatusBarHeightV2(Activity context) {
        // 获得状态栏高度
        int result = 0;
        int resourceId = context.getResources().getIdentifier("status_bar_height", "dimen", "android");
    ...
    public static int getStatusBarHeight2(Context context) {
        ...
        return statusBarHeight2 < 40 ? 88 : statusBarHeight2;
    }
    ...
    private static int calculateStatusColor(@ColorInt int color, int alpha) {
        ...
        //        int a = Math.min(255, Math.max(0, alpha)) << 24;
     ...
     * @return 最终的状态栏颜色
     */
    public static int getStatusColor(@ColorInt int color, int alpha) {
        if (alpha == 0) {
            return color;
        }
        float a = 1 - alpha / 255f;
    ...
    public static void setStatusBarMode(Activity activity, boolean bDark) {
        ...
        setMeizuStatusBarDarkIcon2(activity, bDark);
        setMiuiStatusBarDarkMode(activity, bDark);
    }

    public static boolean setMeizuStatusBarDarkIcon2(Activity activity, boolean dark) {
