...
import com.meilancycling.mema.ui.details.LapDetailsActivity;

/**
 * @author ：https://blog.csdn.net/u013000152/article/details/80855315
 * 采用今日头条的适配方案
 * <p>
 * 调用：setDensity();
 */
    ...
    private static void registerActivityLifecycleCallbacks(Application application) {
        application.registerActivityLifecycleCallbacks(new Application.ActivityLifecycleCallbacks() {
            ...
            public void onActivityResumed(Activity activity) {
                if (activity instanceof DetailsHomeActivity) {
                    setDefault(activity);
                } else if (activity instanceof HorizontalScreenActivity) {
                    setDefault(activity);
                } else if (activity instanceof LapDetailsActivity) {
                    setDefault(activity);
                }
            }
