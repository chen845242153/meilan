 ...
 */
public class LapDetailsView extends LinearLayout {

    private AggregateDataBinding mAggregateDataBinding;

    public LapDetailsView(Context context) {
        super(context);
        init();
    }

    public LapDetailsView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public LapDetailsView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
