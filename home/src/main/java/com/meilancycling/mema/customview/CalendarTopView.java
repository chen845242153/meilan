 ...
 */
public class CalendarTopView extends LinearLayout {
    ...
    public CalendarTopView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public CalendarTopView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public void init() {
        ...
        if (inflater != null) {
            mCalendarTopBinding = DataBindingUtil.inflate(inflater, R.layout.calendar_top, this, false);
    ...
    public void setData(String value, String type, String unit) {
        ...
        if (TextUtils.isEmpty(unit)) {
            ...
            if ("Time".equals(type) || "Calories".equals(type)) {
                mCalendarTopBinding.tvCalendarUnit.setText(unit);
            } else {
